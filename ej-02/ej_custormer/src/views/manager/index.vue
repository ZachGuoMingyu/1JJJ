<template>
  <div class="index">
    ...
    <!-- 栏目区域 -->
    <div class="category">
      <!-- 去组建库中寻找合适的组件 导航组件 宫格grid 自定义列数-->
      <van-grid :column-num="3">
        ...
        <!-- 我们要把当前点击的id 和 index全部传递 拿到id的作用是当我们点击进入详情页面的时候 要确保侧边菜单栏是我们点击的栏目 而且还要根据id拿到当前栏目的详情 -->
        ...
        <van-grid-item icon="home-o" text="更多" badge="更多" />
      </van-grid>
    </div>
    <!-- 配置完以后 开始获取栏目数据 -->
